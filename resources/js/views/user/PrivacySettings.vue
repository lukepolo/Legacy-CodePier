    ...
    <div>
        <div class="flyform--group">
            ...
            <div class="toggleSwitch">
                No &nbsp;
                <div @click="toggleMarketing" class="toggleSwitch--button toggleSwitch--button-switch" :class="{ right : user.marketing , left : !user.marketing}"></div> &nbsp; Yes
            </div>
        ...
        <div class="flyform--group">
            ...
            <div class="toggleSwitch">
                No &nbsp;
                <div @click="toggleProcessing" class="toggleSwitch--button toggleSwitch--button-switch" :class="{ right : user.processing , left : !user.processing}"></div> &nbsp; Yes
            </div>
            <small>Data processing is only used for bug reporing and support chat.</small>
        </div>

        <div class="flyform--footer">
            <div class="flyform--footer-btns">
                <button @click="showDeleteAccountModal = true" class="btn--link btn--link-danger">Delete My Account</button>
                <button class="btn" @click="requestData">Request My Data</button>
            </div>
        </div>
        <modal v-if="showRequestDataModal">
            <div class="modal--header">
                <h1>You have requested your data!</h1>
            </div>
            <div class="modal--body">
                <p>
                    It may take up to 48 hours to process your data to send to you. You will receive it at {{ user.email }}.
                </p>
            </div>

            <div class="modal--footer">
                <span class="btn btn-primary" @click="showRequestDataModal=false">Close</span>
            </div>
        </modal>
        ...
        <modal v-if="showDeleteAccountModal">
            ...
            <div class="modal--footer">
                ...
                <span class="btn btn-primary" @click="showDeleteAccountModal=false">CANCEL</span>
            </div>
        </modal>
    </div>
</template>
