<template>
  <div class="grid-5">
    <div class="flyform--group">
      <label>Run Every (interval)</label>
    ...
    <div class="flyform--group" v-if="showDaysSelector">
      <label>on the (day of month)</label>
    ...
    <div class="flyform--group" v-if="showMinuteSelector">
      <label
        ><span v-if="!showHourSelector">at</span>
        <span v-if="showHourSelector">and</span> (minute)</label
      >
      <div class="flyform--group-select">
...
<script>
import ordinalize from "@app/helpers/ordinalize";
export default {
  model: {
    prop: "cronTiming",
  },
