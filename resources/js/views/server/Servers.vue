        ...
        <div class="flyform--footer">
          ...
          <div class="flyform--footer-btns">
            <confirm confirm_class="btn btn-primary">
              <div slot="form">
                <p>
                  By creating and customizing a site first CodePier will set up
                  server defaults automatically.
                </p>
...
export default {
  created() {
    this.$store.dispatch("user/servers/get");
  },
  data() {
    return {
      showArchive: false,
  ...
  watch: {
    showArchive: function() {
      this.$store.dispatch("user/servers/getDeletedServers");
    },
  },
  computed: {
    servers() {
      if (!this.showArchive) {
        return this.$store.state.user.servers.servers;
      }
      return this.$store.state.user.servers.deletedServers;
    },
  },
};
</script>
