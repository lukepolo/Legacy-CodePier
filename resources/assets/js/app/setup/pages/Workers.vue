  ...
  <section>
          ...
          <td class="table--action">
            <tooltip message="Delete">
              <span class="table--action-delete">
                <a @click="deleteWorker(worker.id)"
    ...
    <form @submit.prevent="installWorker()" v-if="shouldShowForm">
      ...
      <div class="flyform--group">
        ...
        <label class="flyform--group-iconlabel" for="working_directory"
      ...
      <div class="flyform--group"><label>Worker Options</label></div>
      <div class="flyform--group-checkbox">
        <label>
          <input type="checkbox" name="auto_start" v-model="form.auto_start" />
          <span class="icon"></span> Auto Start
        </label>
      </div>
      ...
      <div class="flyform--group-checkbox">
        <label>
          ...
          />
          <span class="icon"></span> Auto Restart
        </label>
      </div>

      <div class="flyform--footer">
        <div class="flyform--footer-btns">
          <span class="btn" v-if="workers.length" @click.prevent="resetForm"
            >Cancel</span
          >
