        ...
        <div slot="content" class="dropdown-menu dropdown-content nowrap">
          <h3>
            <confirm-dropdown :params="{ server: server.id }">
              Sudo Password
              <tooltip
                message="Refresh Sudo Password"
                v-if="server.progress >= 100"
              >
                <a @click.prevent.stop="refreshSudoPassword" href="#"
          ...
          <button
            ...
            @click.stop="revealSudoPassword"
            v-if="!sudoPassword"
          >
            <span class="icon-visibility"></span> Reveal
          </button>
      ...
      <drop-down tag="span">
        ...
        <div slot="content" class="dropdown-menu dropdown-content nowrap">
          ...
          <button
            ...
            @click.stop="revealDatabasePassword"
          >
            <span class="icon-visibility"></span> Reveal
          </button>
