        ...
        <div class="container">
          ...
          >
            ...
            <server-provider-selector
              :server_provider_id.sync="server_provider_id"
              :is_custom.sync="is_custom"
            ></server-provider-selector>
            ...
            <template v-if="is_custom || server_provider_id">
              ...
              >
                <div class="flyform--group">
                  ...
                  <div class="flyform--group-select">
                    <select name="server_option" v-model="form.serverOptionId">
                      <option></option>
                      <option
                        v-for="option in server_options"
                        :value="option.id"
                      >
                        {{
                ...
                <div class="flyform--group">
                  ...
                  <div class="flyform--group-select">
                    <select
                      name="server_region"
                      v-model="form.serverOptionRegion"
                    >
                      <option
                ...
                <div
                  ...
                  v-if="
                    server_provider_features &&
                      server_provider_features.length > 0
                  "
                >
              ...
              <div class="flyform--footer">
                <div class="flyform--footer-links">
                  ...
                  <h3 v-else>Set up your server :</h3>
                </div>
              </div>
