      ...
      <div class="section-content">
        <div class="container">
          <ul class="wizard">
            <li
              class="wizard-item"
              v-bind:class="{ 'router-link-active': !showArchive }"
            >
              ...
              <tr v-for="server in servers">
                  ...
                  <template v-else>
                    ...
                    >
                      <div class="flex flex--center">
                        <textarea rows="2" style="min-width:350px;" readonly>{{
                          server.custom_server_url
                        }}</textarea>
                        <div class="flex--spacing">
                          <clipboard
                            :data="server.custom_server_url"
                          ></clipboard>
                        </div>
                      </div>
                    </template>
                ...
                <td class="text-right">
                  <template v-if="server.deleted_at">
                    ...
                    <confirm
                      confirm_position="left"
                      dispatch="user_servers/deleteServer"
                      confirm_class="btn btn-danger"
                      message="This does not delete this from your server provider!"
                      :params="server.id"
                    >
          ...
          <div class="flyform--footer">
            <h3>
              While we do offer the ability to create a server manually, we
              suggest creating a site first,<br />
            ...
            <div class="flyform--footer-btns">
              <confirm confirm_class="btn btn-primary">
                <div slot="form">
                  <p>
                    By creating and customizing a site first CodePier will set
                    up server defaults automatically.
                  </p>
                  <div class="alert alert-error">
                    You should only do this if you have advanced server
                    knowledge.
                  </div>
                </div>
                <router-link
