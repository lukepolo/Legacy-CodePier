    ...
    var routes = {
      ...
      routes: [
        ...
        },
        {
          ...
          action:
            "LaravelHorizonHttpControllersMasterSupervisorController@index"
        },
        {
          host: null,
          methods: ["GET", "HEAD"],
        ...
        },
        {
          ...
          methods: ["GET", "HEAD"],
          uri:
            "api/my/sites/{site}/notification-channels/{notification_channel}",
        ...
        },
        {
          host: null,
          methods: ["GET", "HEAD"],
          uri: "subscription/invoices/{invoice}",
          name: null,
          action: "UserSubscriptionUserSubscriptionInvoiceController@show"
        },
        {
