export default {
    ...
    actions: {
        ...
        getBuoys: ({ commit }) => {
            Vue.http.get(Vue.action("BuoyAppController@index")).then(
                response => {
        ...
        updateBuoy: ({ commit }, data) => {
            Vue.http
                .post(
                    Vue.action("BuoyAppController@update", {
                        buoy_app: data.buoy_app
                    }),
                    data.form,
                    {
                        headers: {
        ...
        deleteBuoy: ({ commit }, buoyApp) => {
            Vue.http
                .delete(
                    Vue.action("BuoyAppController@destroy", {
                        buoy_app: buoyApp
                    }),
                    data
                )
    ...
    mutations: {
        ...
        REMOVE_BUOY: (state, buoyAppId) => {
            Vue.set(
                state,
                "buoy_apps",
                _.reject(state.buoy_app, { id: buoyAppId })
            );
        }
    }
};
