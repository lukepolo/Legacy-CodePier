...
(function($) {
  ...
  function hasError(c, o) {
    ...
    if (
      !defined(o.openSpeed) ||
      (typeof o.openSpeed != "number" &&
        (typeof o.openSpeed == "string" &&
          (o.openSpeed != "slow" && o.openSpeed != "fast")))
    ) {
      $.error('gentleSelect: openSpeed must be an integer or "slow" or "fast"');
      return true;
    }
    if (
      !defined(o.closeSpeed) ||
      (typeof o.closeSpeed != "number" &&
        (typeof o.closeSpeed == "string" &&
          (o.closeSpeed != "slow" && o.closeSpeed != "fast")))
    ) {
      $.error(
    ...
    if (
      !defined(o.openEffect) ||
      (o.openEffect != "fade" && o.openEffect != "slide")
    ) {
      $.error("gentleSelect: openEffect must be either 'fade' or 'slide'!");
      return true;
    }
    if (
      !defined(o.closeEffect) ||
      (o.closeEffect != "fade" && o.closeEffect != "slide")
    ) {
  ...
  var methods = {
    init: function(options) {
      ...
      var label = $(
        "<span class='gentleselect-label'>" + label_text + "</span>"
      )
        .insertBefore(this)
        ...
        .data("root", this);
      this.data("label", label).data("options", o);
      ...
      if (defined(o.title)) {
        $("<div class='gentleselect-title'>" + o.title + "</div>").prependTo(
          dialog
        );
      }
