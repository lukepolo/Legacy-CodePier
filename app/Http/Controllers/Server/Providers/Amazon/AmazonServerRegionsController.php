...
class AmazonServerRegionsController extends Controller
{
...
//        return response()->json($regions);
    ...
    public function store()
    {
        return response()->json(
            $this->serverService->getServerRegions(ServerProvider::where('provider_name', AmazonController::AMAZON)->firstOrFail())
        );
    }
}
