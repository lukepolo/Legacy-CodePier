...
class SslCertExpiring extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {
        return 'Your sites SSL certificate for '.$this->site->name.' is expires on '.$this->sslCertificate->expirationDate().', please go to CodePier to create a new certificate.';
    }
}
