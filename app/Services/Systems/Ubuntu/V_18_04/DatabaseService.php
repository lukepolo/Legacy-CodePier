...
class DatabaseService
{
    ...
    public function installPostgreSQL()
    {
        ...
        $this->remoteTaskService->run('sudo -u postgres psql -c "CREATE ROLE codepier LOGIN PASSWORD \'md5' . md5($databasePassword.'codepier') . '\' SUPERUSER INHERIT NOCREATEDB NOCREATEROLE NOREPLICATION;"');
    ...
    {
        $this->remoteTaskService->run("cd /home && sudo -u postgres psql -c \"CREATE ROLE $schemaUser->name LOGIN PASSWORD 'md5".md5($schemaUser->password.$schemaUser->name)."';\"");
