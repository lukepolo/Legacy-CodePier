...
class Ruby
{
    ...
    public function installRuby($version = '2.4')
    {
        ...
        $this->remoteTaskService->run('DEBIAN_FRONTEND=noninteractive apt install -y ruby ruby-dev zlib1g-dev liblzma-dev rng-tools');
        ...
        $this->remoteTaskService->run('DEBIAN_FRONTEND=noninteractive apt install -y apt-transport-https ca-certificates');
        ...
        $this->remoteTaskService->run('DEBIAN_FRONTEND=noninteractive apt install -y nginx-extras passenger');
