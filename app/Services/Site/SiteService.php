    ...
    public function resetWorkflow(Site $site)
    {
        if ($site->servers->count() > 1) {
            $workflow = [
                ...
                'message' => 'You have multiple servers and may have to update your settings. User the server icon <span class="icon-server"></span> to specify which server you want items to run on.',
            ];
