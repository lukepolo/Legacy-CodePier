...
(function () {
    ...
    var laroute = (function () {
        ...
        var routes = {
            ...
            routes : [{"host":null,"methods":["GET","HEAD"],"uri":"login","name":null,"action":"Auth\AuthController@showLoginForm"},{"host":null,"methods":["POST"],"uri":"login","name":null,"action":"Auth\AuthController@login"},{"host":null,"methods":["GET","HEAD"],"uri":"logout","name":null,"action":"Auth\AuthController@logout"},{"host":null,"methods":["GET","HEAD"],"uri":"register","name":null,"action":"Auth\AuthController@showRegistrationForm"},{"host":null,"methods":["POST"],"uri":"register","name":null,"action":"Auth\AuthController@register"},{"host":null,"methods":["GET","HEAD"],"uri":"password\/reset\/{token?}","name":null,"action":"Auth\PasswordController@showResetForm"},{"host":null,"methods":["POST"],"uri":"password\/email","name":null,"action":"Auth\PasswordController@sendResetLinkEmail"},{"host":null,"methods":["POST"],"uri":"password\/reset","name":null,"action":"Auth\PasswordController@reset"},{"host":null,"methods":["GET","HEAD"],"uri":"\/","name":null,"action":"LandingController@getIndex"},{"host":null,"methods":["GET","HEAD"],"uri":"provider\/{provider}\/link","name":null,"action":"Auth\OauthController@newProvider"},{"host":null,"methods":["GET","HEAD"],"uri":"provider\/{provider}\/callback","name":null,"action":"Auth\OauthController@getHandleProviderCallback"},{"host":null,"methods":["GET","HEAD"],"uri":"admin","name":null,"action":"AdminController@getIndex"},{"host":null,"methods":["GET","HEAD"],"uri":"admin\/server-provider\/{providerID}\/options-regions","name":null,"action":"AdminController@getServerOptionsAndRegions"},{"host":null,"methods":["GET","HEAD"],"uri":"my-profile","name":null,"action":"Auth\UserController@getMyProfile"},{"host":null,"methods":["POST"],"uri":"my-profile","name":null,"action":"Auth\UserController@postMyProfile"},{"host":null,"methods":["POST"],"uri":"my-profile\/add-ssh-key","name":null,"action":"Auth\UserController@postAddSshKey"},{"host":null,"methods":["GET","HEAD"],"uri":"my-profile\/remove-ssh-key\/{sshKeyID}","name":null,"action":"Auth\UserController@getRemoveSshKey"},{"host":null,"methods":["GET","HEAD"],"uri":"server\/{serverID}","name":null,"action":"ServerController@getServer"},{"host":null,"methods":["POST"],"uri":"create-server","name":null,"action":"ServerController@postCreateServer"},{"host":null,"methods":["GET","HEAD"],"uri":"server\/{serverID}\/check-connection","name":null,"action":"ServerController@getTestSshConnection"},{"host":null,"methods":["POST"],"uri":"server\/{serverID}\/ssh-key\/install","name":null,"action":"ServerController@postInstallSshKey"},{"host":null,"methods":["GET","HEAD"],"uri":"server\/{serverID}\/ssh-key\/{serverSshKeyId}\/remove","name":null,"action":"ServerController@getRemoveSshKey"},{"host":null,"methods":["POST"],"uri":"server\/{serverID}\/cron-job\/install","name":null,"action":"ServerController@postInstallCronJob"},{"host":null,"methods":["GET","HEAD"],"uri":"server\/{serverID}\/cron-job\/{cronJobID}\/remove","name":null,"action":"ServerController@getRemoveCronJob"},{"host":null,"methods":["POST"],"uri":"server\/{serverID}\/firewall-rule\/add","name":null,"action":"ServerController@postAddFirewallRule"},{"host":null,"methods":["GET","HEAD"],"uri":"server\/{serverID}\/firewall-rule\/{fireWallID}\/remove","name":null,"action":"ServerController@getRemoveFireWallRule"},{"host":null,"methods":["POST"],"uri":"server\/{serverID}\/daemon\/add","name":null,"action":"ServerController@postAddDaemon"},{"host":null,"methods":["GET","HEAD"],"uri":"server\/{serverID}\/daemon\/{daemonID}\/remove","name":null,"action":"ServerController@getRemoveDaemon"},{"host":null,"methods":["GET","HEAD"],"uri":"server\/{serverID}\/site\/{siteID}","name":null,"action":"SiteController@getSite"},{"host":null,"methods":["POST"],"uri":"server\/{serverID}\/create-site","name":null,"action":"SiteController@postCreateSite"},{"host":null,"methods":["GET","HEAD"],"uri":"server\/{serverID}\/site\/{siteID}\/deploy","name":null,"action":"SiteController@getDeploy"},{"host":null,"methods":["GET","HEAD"],"uri":"server\/{serverID}\/site\/{siteID}\/env-file","name":null,"action":"SiteController@getEnv"},{"host":null,"methods":["POST"],"uri":"server\/{serverID}\/site\/{siteID}\/install-repository","name":null,"action":"SiteController@postInstallRepository"},{"host":null,"methods":["POST"],"uri":"server\/{serverID}\/site\/{siteID}\/domain\/rename","name":null,"action":"SiteController@postRenameDomain"},{"host":null,"methods":["POST"],"uri":"server\/{serverID}\/site\/{siteID}\/ssl\/lets-encrypt","name":null,"action":"SiteController@postRequestLetsEncryptSSLCert"},{"host":null,"methods":["POST"],"uri":"server\/{serverID}\/site\/{siteID}\/env","name":null,"action":"SiteController@postEnv"},{"host":null,"methods":["GET","HEAD"],"uri":"_debugbar\/open","name":"debugbar.openhandler","action":"Barryvdh\Debugbar\Controllers\OpenHandlerController@handle"},{"host":null,"methods":["GET","HEAD"],"uri":"_debugbar\/clockwork\/{id}","name":"debugbar.clockwork","action":"Barryvdh\Debugbar\Controllers\OpenHandlerController@clockwork"},{"host":null,"methods":["GET","HEAD"],"uri":"_debugbar\/assets\/stylesheets","name":"debugbar.assets.css","action":"Barryvdh\Debugbar\Controllers\AssetController@css"},{"host":null,"methods":["GET","HEAD"],"uri":"_debugbar\/assets\/javascript","name":"debugbar.assets.js","action":"Barryvdh\Debugbar\Controllers\AssetController@js"}],
            prefix: '',
