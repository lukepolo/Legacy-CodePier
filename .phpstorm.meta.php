...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        ...
        'digitalocean.adapterfactory' => \GrahamCampbell\DigitalOcean\Adapters\ConnectionFactory::class,
        'digitalocean.factory' => \GrahamCampbell\DigitalOcean\DigitalOceanFactory::class,
        'digitalocean' => \GrahamCampbell\DigitalOcean\DigitalOceanManager::class,
        'digitalocean.connection' => \DigitalOceanV2\DigitalOceanV2::class,
        ...
        'teamwork' => \Mpociot\Teamwork\Teamwork::class,
        ...
        'App\Contracts\Systems\SystemServiceContract' => \App\Services\Systems\SystemService::class,
        'App\Contracts\Server\ServerFeatureServiceContract' => \App\Services\Server\ServerFeatureService::class,
        'App\Contracts\Server\ServerLanguageSettingsServiceContract' => \App\Services\Server\ServerLanguageSettingsService::class,
        'App\Contracts\Site\SiteServiceContract' => \App\Services\Site\SiteService::class,
        'App\Contracts\Site\SiteFeatureServiceContract' => \App\Services\Site\SiteFeatureService::class,
        'App\Contracts\Site\SiteDeploymentStepsServiceContract' => \App\Services\Site\SiteDeploymentStepsService::class,
        'App\Contracts\Site\SiteLanguageSettingsServiceContract' => \App\Services\Site\SiteLanguageSettingsService::class,
        'App\Contracts\BuoyServiceContract' => \App\Services\Buoys\BuoyService::class,
    ]));
