 ...
 * Generated for Laravel 5.6.5 on 2018-02-25 20:03:15.
 *
...
namespace Sentry\SentryLaravel {
    class SentryFacade
    {
         ...
         * @static
         */
        public static function message($message, $params = [], $level = 'info', $stack = false, $vars = null)
        {
         ...
         * @static
         */
        public static function captureMessage($message, $params = [], $data = [], $stack = false, $vars = null)
        {
         ...
         * @static
         */
        public static function set_user_data($id, $email = null, $data = [])
        {
...
namespace Mpociot\Teamwork\Facades {
    class Teamwork
    {
         ...
         *
         * @param $email
         * @param \Mpociot\Teamwork\Team|array|int $team
         *
         * @return bool
         * @static
         */
